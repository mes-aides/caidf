...
let additions
try {
  additions = require("../../src/context/custom-questions.js")
} catch (error) {
  console.log(error)
}
      ...
      ...(demandeur
        ? [
            ...
            },
            {
              ...
              steps: [r("_formationSanitaireSocial")],
            },
            {
              isActive: (subject) =>
...
function extraBlock() {
  ...
  return {
    ...
    steps: [
      ...
      {
        isActive: (subject) => {
          return !subject._formationSanitaireSocial
        },
...
function generateBlocks(situation) {
  ...
  if (additions && additions.addBlocks) {
    additions.addBlocks(initial)
  }
  //console.log(initial)
  return initial
}
